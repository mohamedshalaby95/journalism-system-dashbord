...
const getPendingPostSuccese = (data: any) => ({
...
const acceptPostSuccess = (id: string) => ({
  type: ACCEPT_PENDING_POST,
  payload: id,
});
...
const cancelPendingSuccess = (id: string) => ({
  type: CANCEL_PENDING_POST,
  payload: id,
});
